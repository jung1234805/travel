            ...
            <TouchableWithoutFeedback onPress = {Keyboard.dismiss}>
                <View style={styles.common}>
                  ...
                  <StyledView>
                    ...
                    <StyledText/>
                    <StyledText/>
                    <TouchableOpacity onPress={()=>navigation.navigate('map',{lat: 37.512082788901246, lon: 127.05904371140454})}><Feather name="map-pin" size={24} color="black" /></TouchableOpacity>
                  </StyledView>
                  <StyledView>
                    <StyledText>주소 : 서울특별시 강남구 영동대로 513 </StyledText>
                  </StyledView>
                  <StyledView>
